...
public class DefaultVehicleRoutingRestService implements VehicleRoutingRestService {
    ...
    @Override
    public JsonMessage clearSolution() {
        boolean success = solverManager.clearSolution(request.getSession().getId());
        return new JsonMessage(success? "Cleared previous solution.": "Couldn't clear previous solution.");
    }
